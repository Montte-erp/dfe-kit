...
export type FiscalDocumentStatus = "draft" | "queued" | "sending" | "accepted_pending_authorization" | "authorized" | "rejected" | "cancellation_queued" | "cancelled" | "technical_error_retryable" | "technical_error_terminal";
export type FiscalProviderCapability = "issue_nfse" | "submit_rps_batch" | "submit_rps_batch_sync" | "query_rps_batch" | "query_nfse_by_rps" | "generate_nfse" | "query_issued_nfse" | "query_received_nfse" | "query_nfse_range" | "cancel_nfse" | "replace_nfse" | "issue_nfe" | "issue_nfce";
export type FiscalProviderCapabilityStatus = "supported" | "unsupported" | "unverified_in_homologation";
...
export interface FiscalProvider {
    ...
    issue(input: IssueFiscalDocumentInput): Promise<Result<IssueFiscalDocumentResponse, FiscalProviderError>>;
}
