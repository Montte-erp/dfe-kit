...
4. **Provedor para primeira validação automatizada de homologação**: Nuvem Fiscal ou Focus NFe. Escolha final deve ser feita com teste de homologação, não só leitura de docs.
